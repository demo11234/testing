...
export class UserService {
   ...
   * @author Jeetanshu Srivastava
   */
  async update(walletAddress: string, updateUserDto: UpdateUserDto): Promise<any> {
    try {
      let user = await this.userRepository.updateUserDetails(walletAddress, updateUserDto);
      if (!user) return null;
